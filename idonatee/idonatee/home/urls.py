...
urlpatterns = [
    ...
    path('rorgreq',views.rorgreq, name='rorgreq'),
    path('rqhos',views.rqhos, name='rqhos'),
    path('rhosreq',views.rhosreq, name='rhosreq'),
    ...
    path('oqdon',views.oqdon, name='oqdon'),
    path('odonreq',views.odonreq, name='odonreq'),
    path('oqrec',views.oqrec, name='oqrec'),
    path('orecreq',views.orecreq, name='orecreq'),
    path('oqhos',views.oqhos, name='oqhos'),
    path('ohosreq',views.ohosreq, name='ohosreq'),
    ...
    path('hqdon',views.hqdon, name='hqdon'),
    path('hdonreq',views.hdonreq, name='hdonreq'),
    path('hqrec',views.hqrec, name='hqrec'),
    path('hrecreq',views.hrecreq, name='hrecreq'),
    path('hqorg',views.hqorg, name='hqorg'),
    path('horgreq',views.horgreq, name='horgreq'),
